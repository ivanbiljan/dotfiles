...
hl.bind(mainMod .. " + ALT + F",      hl.dsp.exec_cmd(HYPRSCRIPTS .. "/screenshot.sh --instant")) -- Instant full-screen screenshot
hl.bind(mainMod .. " + SHIFT + S",    hl.dsp.exec_cmd(HYPRSCRIPTS .. "/screenshot.sh --instant-area")) -- Instant area screenshot
hl.bind(mainMod .. " + CTRL + Q",     hl.dsp.exec_cmd("~/.config/ml4w/scripts/wlogout.sh"))     -- Start wlogout
hl.bind(mainMod .. " + SHIFT + W",    hl.dsp.exec_cmd("~/.config/hypr/scripts/waypaper.sh --random")) -- Change the wallpaper
hl.bind(mainMod .. " + CTRL + W",     hl.dsp.exec_cmd("~/.config/hypr/scripts/waypaper.sh"))    -- Open wallpaper selector
...
hl.bind(mainMod .. " + ALT + S",      hl.dsp.exec_cmd("~/.config/ml4w/scripts/sidepad.sh --select")) -- Select Sidepad

-- Workspaces
-- Switch workspaces with mainMod + [0-9]
-- Move active window to a workspace with mainMod + SHIFT + [0-9]
-- Move all windows to a workspace with mainMod + CTRL + [0-9]
for i = 1, 10 do
...
hl.bind("XF86AudioRaiseVolume",  hl.dsp.exec_cmd("wpctl set-volume -l 1 @DEFAULT_AUDIO_SINK@ 2%+"), { locked = true, repeating = true }) -- Increase volume
hl.bind("XF86AudioLowerVolume",  hl.dsp.exec_cmd("wpctl set-volume @DEFAULT_AUDIO_SINK@ 2%-"),      { locked = true, repeating = true }) -- Reduce volume
