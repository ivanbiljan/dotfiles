-- -----------------------------------------------------
-- Color palette
-- Exposed as the global `colors` table so other config
-- files can reference e.g. colors.primary / colors.color11
-- -----------------------------------------------------
...
-- ML4W aliases (was: $color8 = $primary / $color11 = $on_surface)
colors.color8 = colors.primary
